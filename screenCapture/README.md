...
В runtime границы окон определяются через Lua parsers. В тестах границы остаются теми же, но изображение подменяется
fixture-файлом.

## Основное ограничение

Capture и segmentation ориентированы на конкретный вид UI аддонов, разрешение и цвет. Изменение темы, размера, позиции
или визуального стиля аддона может потребовать новых масок/параметров.
