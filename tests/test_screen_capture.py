...
class TestCoordsAndHeadingCapture:
    ...
    @pytest.mark.parametrize(
        'eso_locate_capture, expected_location', [
            pytest.param(Path("Fri Sep  4 21_40_27 2026 298515 221476 10289 19 270 269.jpeg"), (298515, 221476, 10289, 270, 269), id="Fri Sep  4 21_40_27 2026 => position: (298515, 221476, 10289, 270, 269)"),
