...
Исторический script для автоматической вставки содержимого `doc/requirements.csv` и `doc/test_cases.csv` в секцию
корневого README.
...
Этот механизм синхронизирует только старую статическую документацию. Он не сопоставляет requirements с pytest-кодом и не
знает фактического статуса реализации.
